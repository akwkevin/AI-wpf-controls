...
{
    public abstract class NavigationTitleViewModel : TitleViewModel, INavigationAware
    {

        public NavigationTitleViewModel() : base()
        {
        ...
        {
            var key = navigationContext.NavigationService.Region.Name + "_" + navigationContext.Uri.ToString();
