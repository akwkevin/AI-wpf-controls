...
namespace AIStudio.Wpf.Controls.Demo.Helpers
{
    public static class TextEditorHelper
    {
        public static readonly DependencyProperty AttachProperty =
            DependencyProperty.RegisterAttached("Attach", typeof(bool), typeof(TextEditorHelper), new PropertyMetadata(false, OnAttachChanged));
