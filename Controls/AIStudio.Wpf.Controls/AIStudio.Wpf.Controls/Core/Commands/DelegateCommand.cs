...
namespace AIStudio.Wpf.Controls.Commands
{
    ...
    public class DelegateCommand<T1> : IDelegateCommand
    {
        #region Constructors
        ...
        ///     Constructor
        /// </summary>
        public DelegateCommand(Action<T1> executeMethod)
            : this(executeMethod, null, false)
        {
        }
        ...
        ///     Constructor
        /// </summary>
        public DelegateCommand(Action<T1> executeMethod, Func<T1, bool> canExecuteMethod)
            : this(executeMethod, canExecuteMethod, false)
        {
        }
        ...
        ///     Constructor
        /// </summary>
        public DelegateCommand(Action<T1> executeMethod, Func<T1, bool> canExecuteMethod, bool isAutomaticRequeryDisabled)
        {
            if (executeMethod == null)
            {
                throw new ArgumentNullException("executeMethod");
    ...
    public class DelegateCommand<T1, T2> : IDelegateCommand
    {
        #region Constructors
    ...
    public class DelegateCommand<T1, T2, T3> : IDelegateCommand
    {
        #region Constructors
        ...
        ///     Constructor
        /// </summary>
        public DelegateCommand(Action<T1, T2, T3> executeMethod)
            : this(executeMethod, null, false)
        {
        }
        ...
        ///     Constructor
        /// </summary>
        public DelegateCommand(Action<T1, T2, T3> executeMethod, Func<T1, T2, T3, bool> canExecuteMethod)
            : this(executeMethod, canExecuteMethod, false)
        {
        }
        ...
        ///     Constructor
        /// </summary>
        public DelegateCommand(Action<T1, T2, T3> executeMethod, Func<T1, T2, T3, bool> canExecuteMethod, bool isAutomaticRequeryDisabled)
        {
            if (executeMethod == null)
            {
                throw new ArgumentNullException("executeMethod");
