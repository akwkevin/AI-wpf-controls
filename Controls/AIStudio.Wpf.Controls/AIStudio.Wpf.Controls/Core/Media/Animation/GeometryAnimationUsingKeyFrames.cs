...
namespace AIStudio.Wpf.Controls.Media.Animation
{
    ...
    public class GeometryAnimationUsingKeyFrames : GeometryAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        public string[] Strings
        {
            get
            {
                ...
                return _strings != null ? _strings : Regex.Split(_keyFrames[0].Value.ToString(CultureInfo.InvariantCulture), RegularPatterns.DigitsPattern);
            }
        }
        ...
        protected sealed override Duration GetNaturalDurationCore(System.Windows.Media.Animation.Clock clock) => new Duration(LargestTimeSpanKeyTime);
