...
namespace AIStudio.Wpf.Controls
{
    ...
    public class TransitioningContentControl : ContentControl
    {
        ...
        public string CustomVisualStatesName
        {
            get
            {
                return (string)this.GetValue(CustomVisualStatesNameProperty);
            }
            set
            {
                this.SetValue(CustomVisualStatesNameProperty, value);
            }
        }
        ...
        public TransitionType Transition
        {
            get
            {
                return (TransitionType)this.GetValue(TransitionProperty);
            }
            set
            {
