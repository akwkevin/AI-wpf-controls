...
namespace AIStudio.Wpf.Controls
{
    public class FlipNumber : Viewport3D
    {
        ...
        public static readonly DependencyProperty NumberProperty = DependencyProperty.Register(
            "Number", typeof(int), typeof(FlipNumber), new PropertyMetadata(0, OnNumberChanged));
        ...
        private Viewport2DVisual3D CreateNumber(int num, bool isUp, out TextBlock textBlock)
        {
            ...
            bindingForeground.Path = new PropertyPath(TextBlock.ForegroundProperty);
            bindingForeground.Mode = BindingMode.OneWay;
            bindingForeground.Source = this;
            textBlock.SetBinding(TextBlock.ForegroundProperty, bindingForeground);
            ...
            bindingBackground.Path = new PropertyPath(FlipNumber.BackgroundProperty);
