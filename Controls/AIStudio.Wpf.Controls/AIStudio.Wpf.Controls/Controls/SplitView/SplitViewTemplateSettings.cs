namespace AIStudio.Wpf.Controls
{
    ...
    public sealed class SplitViewTemplateSettings : DependencyObject
    {
        ...
        public GridLength CompactPaneGridLength
        {
            get
            {
                return (GridLength)this.GetValue(CompactPaneGridLengthProperty);
            }
            private set
            {
                this.SetValue(CompactPaneGridLengthProperty, value);
            }
        }
        ...
        public double NegativeOpenPaneLength
        {
            get
            {
                return (double)this.GetValue(NegativeOpenPaneLengthProperty);
            }
            private set
            {
                this.SetValue(NegativeOpenPaneLengthProperty, value);
            }
        }
        ...
        public double NegativeOpenPaneLengthMinusCompactLength
        {
            get
            {
                return (double)this.GetValue(NegativeOpenPaneLengthMinusCompactLengthProperty);
            }
            set
            {
                this.SetValue(NegativeOpenPaneLengthMinusCompactLengthProperty, value);
            }
        }
        ...
        public GridLength OpenPaneGridLength
        {
            get
            {
                return (GridLength)this.GetValue(OpenPaneGridLengthProperty);
            }
            private set
            {
                this.SetValue(OpenPaneGridLengthProperty, value);
            }
        }
        ...
        public double OpenPaneLengthMinusCompactLength
        {
            get
            {
                return (double)this.GetValue(OpenPaneLengthMinusCompactLengthProperty);
            }
            private set
            {
                this.SetValue(OpenPaneLengthMinusCompactLengthProperty, value);
            }
        }
