...
namespace AIStudio.Wpf.Controls
{
    public class AnimationPath : Shape
    {
        ...
        public static readonly DependencyProperty PathLengthProperty = DependencyProperty.Register(
            nameof(PathLength), typeof(double), typeof(AnimationPath), new FrameworkPropertyMetadata(0d, OnPropertiesChanged));
        ...
        public static readonly DependencyProperty IsPlayingProperty = DependencyProperty.Register(
            nameof(IsPlaying), typeof(bool), typeof(AnimationPath), new FrameworkPropertyMetadata(false, (o, args) => {
        ...
        public static readonly DependencyProperty RepeatBehaviorProperty = DependencyProperty.Register(
            nameof(RepeatBehavior), typeof(RepeatBehavior), typeof(AnimationPath), new PropertyMetadata(RepeatBehavior.Forever));
        ...
        static AnimationPath()
        {
            ...
            StrokeThicknessProperty.AddOwner(typeof(AnimationPath), new FrameworkPropertyMetadata(0d,
                OnPropertiesChanged));
        }
