...
namespace AIStudio.Wpf.Controls
{
    public sealed class Notification : System.Windows.Window
    {
        ...
        public static Notification Show(object content, ShowAnimation showAnimation = ShowAnimation.None, bool staysOpen = false, ControlStatus? controlStatus = null)
        {
            ...
            {
                notification.SetValue(ControlAttach.StatusProperty, controlStatus);
            }
