...
namespace AIStudio.Wpf.Controls
{
    public class CycleLoading : ContentControl
    {
        ...
        internal string ValueDescription
        {
            get
            {
                return (string)GetValue(ValueDescriptionProperty);
            }
            set
            {
                SetValue(ValueDescriptionProperty, value);
            }
        }
        ...
        public bool IsStart
        {
            get
            {
                return (bool)GetValue(IsStartProperty);
            }
            set
            {
        ...
        public string LoadTitle
        {
            get
            {
                return (string)GetValue(LoadTitleProperty);
            }
            set
            {
                SetValue(LoadTitleProperty, value);
            }
        }
