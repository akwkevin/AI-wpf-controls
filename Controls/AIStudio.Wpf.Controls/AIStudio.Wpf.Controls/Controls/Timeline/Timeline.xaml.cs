...
namespace AIStudio.Wpf.Controls
{
    ...
    public class Timeline : ItemsControl
    {
        ...
        public DataTemplate FirstSlotTemplate
        {
            get
            {
                return (DataTemplate)GetValue(FirstSlotTemplateProperty);
            }
            set
            {
                SetValue(FirstSlotTemplateProperty, value);
            }
        }
        ...
        public DataTemplate MiddleSlotTemplate
        {
            get
            {
                return (DataTemplate)GetValue(MiddleSlotTemplateProperty);
            }
            set
            {
                SetValue(MiddleSlotTemplateProperty, value);
            }
        }
        ...
        public DataTemplate LastSlotTemplate
        {
            get
            {
                return (DataTemplate)GetValue(LastSlotTemplateProperty);
            }
            set
            {
                SetValue(LastSlotTemplateProperty, value);
            }
        }
        ...
        public bool IsCustomEverySlot
        {
            get
            {
                return (bool)GetValue(IsCustomEverySlotProperty);
            }
            set
            {
                SetValue(IsCustomEverySlotProperty, value);
            }
        }
        ...
        public DataTemplate SlotTemplate
        {
            get
            {
                return (DataTemplate)GetValue(SlotTemplateProperty);
            }
            set
            {
                SetValue(SlotTemplateProperty, value);
            }
        }
