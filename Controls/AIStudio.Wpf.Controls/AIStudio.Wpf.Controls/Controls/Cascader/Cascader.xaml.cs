...
namespace AIStudio.Wpf.Controls
{
    ...
    public class Cascader : Control
    {
        ...
        public string ChildMemberPath
        {
            get
            {
                return (string)GetValue(ChildMemberPathProperty);
            }
            set
            {
                SetValue(ChildMemberPathProperty, value);
            }
        }

        public static readonly DependencyProperty ChildMemberPathProperty =
            DependencyProperty.Register("ChildMemberPath", typeof(string), typeof(Cascader), new PropertyMetadata("Children"));
        ...
        public static readonly DependencyProperty DisplayMemberPathProperty =
            DependencyProperty.Register("DisplayMemberPath", typeof(string), typeof(Cascader), new PropertyMetadata("Name"));
        ...
        public static readonly DependencyProperty IsReadOnlyProperty =
          DependencyProperty.Register("IsReadOnly", typeof(bool), typeof(Cascader), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty MaxDropDownHeightProperty =
            DependencyProperty.Register("MaxDropDownHeight", typeof(double), typeof(Cascader));
        ...
        public static readonly DependencyProperty IsDropDownOpenProperty =
            DependencyProperty.Register("IsDropDownOpen", typeof(bool), typeof(Cascader));
        ...
        public static readonly DependencyProperty StaysOpenProperty =
            DependencyProperty.Register("StaysOpen", typeof(bool), typeof(Cascader));
        ...
        public static readonly DependencyProperty ItemStyleProperty =
            DependencyProperty.Register("ItemStyle", typeof(Style), typeof(Cascader));
        ...
        public static readonly DependencyProperty ItemContainerStyleProperty =
            DependencyProperty.Register("ItemContainerStyle", typeof(Style), typeof(Cascader));
        ...
        public bool IsShowEveryItem
        {
            get
            {
                return (bool)GetValue(IsShowEveryItemProperty);
            }
            set
            {
                SetValue(IsShowEveryItemProperty, value);
            }
        }
        ...
        public bool IsChangeOnSelected
        {
            get
            {
                return (bool)GetValue(IsChangeOnSelectedProperty);
            }
            set
            {
                SetValue(IsChangeOnSelectedProperty, value);
            }
        }
        ...
        public ObservableCollection<object> SelectedValues
        {
            get
            {
                return (ObservableCollection<object>)GetValue(SelectedValuesProperty);
            }
            private set
            {
        ...
        private void CreateContainer(object itemsSource, int deep, object parent)
        {
            ...
            container.SetValue(CascaderListBox.StyleProperty, this.ItemStyle);
            container.SetValue(CascaderListBox.ItemContainerStyleProperty, this.ItemContainerStyle);
