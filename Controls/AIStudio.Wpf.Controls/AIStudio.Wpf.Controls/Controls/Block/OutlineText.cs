...
namespace AIStudio.Wpf.Controls
{
    public class OutlineText : FrameworkElement
    {
        ...
        public static readonly DependencyProperty StrokeThicknessProperty = DependencyProperty.Register(
            nameof(StrokeThickness), typeof(double), typeof(OutlineText), new PropertyMetadata(.0, OnFormattedTextUpdated));
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            // the Math.Min call is important - without this constraint (which seems arbitrary, but is the maximum allowable text _width), things blow up when availableSize is infinite in both directions
