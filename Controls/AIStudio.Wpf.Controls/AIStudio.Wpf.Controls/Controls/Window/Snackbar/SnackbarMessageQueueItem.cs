...
namespace AIStudio.Wpf.Controls
{
    internal class SnackbarMessageQueueItem
    {
        public SnackbarMessageQueueItem(object content, object actionContent = null, Action<object> actionHandler = null, object actionArgument = null,
            bool isPromoted = false, bool ignoreDuplicate = false, ControlStatus controlStatus = ControlStatus.Default, VerticalAlignment verticalAlignment = VerticalAlignment.Bottom)
        {
            Content = content;
