...
namespace AIStudio.Wpf.Controls
{
    ...
    public class Snackbar : Control
    {
        ...
        public SnackbarMessage Message
        {
            get
            {
                return (SnackbarMessage)GetValue(MessageProperty);
            }
            set
            {
        ...
        public SnackbarMessageQueue MessageQueue
        {
            get
            {
                return (SnackbarMessageQueue)GetValue(MessageQueueProperty);
            }
            set
            {
        ...
        public event RoutedPropertyChangedEventHandler<bool> IsActiveChanged
        {
            add
            {
                AddHandler(IsActiveChangedEvent, value);
            }
            remove
            {
                RemoveHandler(IsActiveChangedEvent, value);
            }
        }
        ...
        public event RoutedPropertyChangedEventHandler<SnackbarMessage> DeactivateStoryboardCompleted
        {
            add
            {
                AddHandler(DeactivateStoryboardCompletedEvent, value);
            }
            remove
            {
                RemoveHandler(DeactivateStoryboardCompletedEvent, value);
            }
        }
        ...
        public TimeSpan ActivateStoryboardDuration
        {
            get; private set;
        }

        public TimeSpan DeactivateStoryboardDuration
        {
            get; private set;
        }
