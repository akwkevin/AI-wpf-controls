...
namespace AIStudio.Wpf.PrintDialog.Effect
{
    internal class GrayscaleEffect : ShaderEffect
    {
        private static PixelShader _pixelShader = new PixelShader() { UriSource = new Uri("/AIStudio.Wpf.PrintDialog;component/Effect/Grayscale/GrayscaleEffect.ps", UriKind.Relative) };
