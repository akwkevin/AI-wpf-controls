...
namespace AIStudio.Wpf.PrintDialog
{
    partial class PrintWindow : Window
    {
        ...
        public PrintWindow(FixedDocument document, string documentName, double pageMargin, PrintDialogSettings defaultSettings, bool allowPagesOption, bool allowScaleOption, bool allowTwoSidedOption, bool allowPagesPerSheetOption, bool allowPageOrderOption, bool allowMoreSettingsExpander, bool allowAddNewPrinerComboBoxItem, bool allowPrinterPreferencesButton, Func<DocumentInfo, List<PageContent>> getDocumentWhenReloadDocumentMethod, bool loading, Action loadingAction)
        {
            InitializeComponent();
        ...
        internal void BeginSettingAndPreviewing(FixedDocument document, string documentName, double pageMargin, PrintDialogSettings defaultSettings, bool allowPagesOption, bool allowScaleOption, bool allowTwoSidedOption, bool allowPagesPerSheetOption, bool allowPageOrderOption, bool allowMoreSettingsExpander, bool allowAddNewPrinerComboBoxItem, bool allowPrinterPreferencesButton, Func<DocumentInfo, List<PageContent>> getDocumentWhenReloadDocumentMethod)
        {
